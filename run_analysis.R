...
{	
	...
	training_data <- read.table("project/train/X_train.txt", header=FALSE)
	cat("Training data dimensions are: "); print(dim(training_data));
	
	## Load Test data
	print ("Reading Test data ...")
	test_data <- read.table("project/test/X_test.txt", header=FALSE)
...
step_02 <- function(full_data.tbl)
{
	...
	features <- read.table("project/features.txt", header=FALSE)
...
step_03 <- function(required_data.tbl)
{
	...
	activity_labels.df <- read.table("project/activity_labels.txt", header=FALSE)
	...
	training_activity.df <- read.table("project/train/y_train.txt", header=FALSE)
	# Read test activities from file
	test_activity.df <- read.table("project/test/y_test.txt", header=FALSE)
...
step_05 <- function(data_with_labels.tbl)
{
	...
	training_subject <- read.table("project/train/subject_train.txt", header=FALSE)
	test_subject <- read.table("project/test/subject_test.txt", header=FALSE)
